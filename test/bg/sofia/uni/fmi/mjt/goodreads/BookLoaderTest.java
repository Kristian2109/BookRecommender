...
class BookLoaderTest {
    ...
    void load() {
        ...
        Set<Book> expectedBooks = Set.of(
            new Book("0", "To Kill a Mockingbird", "Harper Lee",
            ...
            new Book("1", "1984", "George Orwell",
                "Totalitarian regime and surveillance",
                List.of("Fiction", "Dystopian"),
                4.6, 276834, "https://example.com/1984"),

            new Book("2", "Pride and Prejudice", "Jane Austen",
                "Romantic comedy about manners",
                List.of("Fiction", "Romance"),
                4.4, 214896, "https://example.com/pride-and-prejudice"),

            new Book("3", "The Hobbit", "J.R.R. Tolkien",
                "Fantasy adventure",
                List.of("Fiction", "Fantasy"),
                4.7, 387654, "https://example.com/the-hobbit")
        );
