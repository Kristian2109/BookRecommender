...
class BookTest {
    ...
    void createsBookOnValidInput() {
        Book expectedBook = new Book(
            "0", "To Kill a Mockingbird", "Harper Lee", "Description\"To Kill A Mockingbird\"",
    ...
    void throwsOnInvalidRating() {
        String[] tokens = {
            "0",
            "To Kill a Mockingbird",
            "Harper Lee", "Description\"To Kill A Mockingbird\"",
            "['Classics', 'Fiction', 'Historical Fiction', 'School', 'Literature', 'Young Adult']",
            "4.27aaa",

            "5,691,311", "https://www.goodreads.com/book/show/2657.To_Kill_a_Mockingbird"
        };
